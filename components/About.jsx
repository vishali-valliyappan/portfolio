      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1 ">
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            applications. With a strong foundation in JavaScript, Next.js, and
            modern UI frameworks, I specialize in building scalable solutions
            that enhance user experience. It is very important to me to build a
            career of stablity, security and opportunity.
          </p>
